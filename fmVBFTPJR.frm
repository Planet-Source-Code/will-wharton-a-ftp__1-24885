...
Private Sub Form_Load()
    ...
    Set imgI = ImageList1.ListImages.Add(, "closed", LoadPicture(App.Path + "\closed.bmp"))
    Set imgI = ImageList1.ListImages.Add(, "leaf", LoadPicture(App.Path + "\leaf.bmp"))
    Set imgI = ImageList1.ListImages.Add(, "root", LoadPicture(App.Path + "\root.bmp"))
